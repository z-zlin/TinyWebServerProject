...
## 压力测试结果
注：测试环境为 Ubuntu 20.04，2C2G 云服务器,使用 Webbench 工具（./webbench -c 1300 -t 30 [URL]），关闭日志后测试（1300 并发连接，持续 30s, 1400并发会出现failed）

|**触发模式**|**事件模型**|**速度（pages/min）**|**吞吐量（bytes/sec）**|**成功请求数**|**较原项目提升率**|
|:---:|:---:|:---:|:---:|:---:|:---:|
...
|ET+ET|Reactor|126364|235881|63182||
||||||
